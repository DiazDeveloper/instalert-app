...
export const routes: Routes = [
  ...
  },
  {
    path: 'comunidades',
    loadComponent: () =>
      import('./communities/presentation/views/community-setup-view/community-setup-view').then(
        (m) => m.CommunitySetupViewComponent,
      ),
  },
  {
    path: 'perfil',
    loadComponent: () =>
      import('./account/presentation/views/profile-view/profile-view').then(
